...
void test("activity distinguishes queued work from pending and reports batch progress", () => {
  const snapshot = deriveEngineActivity([], [{ schemaVersion: 1, batchId: "b", rootJobId: "r", trigger: "manual", scopeId: "all", status: "active", discoveredTotal: 2, createdAt: "2026-08-25T00:00:00.000Z", updatedAt: "2026-08-25T00:00:00.000Z", items: [{ batchItemId: "a".repeat(64), jobId: "j", status: "completed" }] }], { active: false }, { active: false }, true, false, undefined);
